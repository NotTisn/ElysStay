...
public class EnumConversionUnitTests
{
    ...
    [Fact]
    public void ReservationStatus_CanConvertBetweenEnumAndString()
    {
        // Arrange
        ...
        // Act
        var statusString = status.ToString();
        var parsedStatus = Enum.Parse<ReservationStatus>(statusString);
    ...
    [Fact]
    public void ContractStatus_CanConvertBetweenEnumAndString()
    {
        // Arrange
        ...
        // Act
        var statusString = status.ToString();
        var parsedStatus = Enum.Parse<ContractStatus>(statusString);
    ...
    [Fact]
    public void IssueStatus_CanConvertBetweenEnumAndString()
    {
        // Arrange
        ...
        // Act
        var statusString = status.ToString();
        var parsedStatus = Enum.Parse<IssueStatus>(statusString);
    ...
    [Fact]
    public void PriorityLevel_AllValuesExist()
    {
        // Arrange & Act
        var levels = Enum.GetValues(typeof(PriorityLevel));

        // Assert
        levels.Length.Should().BeGreaterThan(0);
    }
}
