...
using ElysStay.Infrastructure.Persistence;
...
public class InvoiceCalculationSteps
{
    ...
    private Service? _waterService;
    private MeterReading? _meterReading;
    private decimal _penaltyAmount = 0;
    ...
    public void ThenTheInvoiceShouldHave(DataTable table)
    {
        ...
        foreach (var row in table.Rows)
        {
            ...
            {
                "RoomAmount" => _generatedInvoice.RoomAmount,
                ...
                "TotalAmount" => _generatedInvoice.RoomAmount + _generatedInvoice.ServiceAmount 
